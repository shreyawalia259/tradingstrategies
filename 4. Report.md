...
**List of Reporoducible Articles**
...
#### Background: A discounted Cash flow model helps to see whether or not a company is overvalued which can give helpful information to use in trading. 
...
### Case 6:Crash Course — Python & Pandas for Trading and Investing (Part 1)
...
### Case 7: Making a Stock Screener with Python!
